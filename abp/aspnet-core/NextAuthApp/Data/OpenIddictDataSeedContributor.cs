...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("NextAuthApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "NextAuthApp",
                DisplayName = "NextAuthApp API",
                Resources =
                {
                    "NextAuthApp"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // React Client
        var reactConfig = configurationSection.GetSection("NextAuthApp_App_React");
